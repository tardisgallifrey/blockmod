...
import com.tardisgallifrey.blockmod.Init.ItemInit.ModCreativeTab;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> SMILEBLOCK =
            BLOCKS.register("smileblock",
    ...
    public static final RegistryObject<Block> SAD_BLOCK =
            BLOCKS.register(
            "sad_block",
    ...
    //Register the mob slayer block
    //its properties copy an iron block from Vanilla
    public static final RegistryObject<Block> MOB_SLAYER =
            BLOCKS.register("mob_slayer",
            () -> new MobSlayerBlock(Block.Properties
